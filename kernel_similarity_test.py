...
#list of valuess ranging from 1e-2 to 5e-2 with step size of .25e-2
...
def main():
    ...
    for i in range(17):
        ...
        # Latent.save(os.path.join(results_dir, f'book_whyte_sharp.png'))
        ...
        # kernel.save(os.path.join(results_dir, f'book_kernel.png'))    
    # Lmx = Latent.max()
    # Lmn = Latent.min()
